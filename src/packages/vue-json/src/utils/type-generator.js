...
export function generatePropsType(props) {
    if (!props)
        return '{}';
...
export function generateStateType(state) {
    if (!state)
        return '{}';
...
export function generateComputedType(computed) {
    if (!computed)
        return '{}';
...
export function generateMethodsType(methods) {
    if (!methods)
        return '{}';
...
export function writeTypeDefinition(schema, outputPath) {
...
export function inferSchemaType(schema) {
    return {
