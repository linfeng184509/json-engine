...
function evaluateStringExpression(expression, context) {
    ...
    try {
        ...
        const result = fn(context.props, context.state, context.computed, context.methods, context.emit, context.slots, context.attrs, context.provide, context.coreScope || {});
...
export function transformFunctionBody(body, stateTypes) {
    let result = body;
